...
<main class="content wrap" role="main">
	<article class="cv">
			...
			<div class="experience" id="radweb-placement">
				...
				<div class="list">
					...
					<ul>
						...
						<li>Developing for a scalable RESTful API with a command bus architecture</li>
		...
		<section class="education">
			...
			<div class="experience" id="portsmouth">
				...
				<div class="list">
					...
					<ul>
						<li>Write programs in PHP, Javascript, Python and Java</li>
						<li>Design, build and maintain web sites and apps</li>
						<li>Work independently and in teams on project work</li>
						<li>Develop new programming solutions, and to adapt to new languages</li>
						<li>Conduct research using different tools and sources</li>
					</ul>
				</div>
			</div>
		...
		<section class="additional-education">
			<h1 class="section-head">Additional Education</h1>

			<div class="experience" id="school">
				<h2 class="experience-head">St. Crispin’s Secondary School, Wokingham</h2>
				<p class="dates">September 2000 - July 2007</p>

				<div class="list unindented">
					<ul>
						<li>3 A-Levels (Biology, Chemistry and Maths).</li>
						<li>1 AS-Level (History).</li>
						<li>12 GCSEs (A-C), including Maths, English, Physics and French.</li>
					</ul>
				</div>
			</div>
		</section>
		...
		<section class="interests">
			...
			<div class="experience" id="scouts">
				<h2 class="experience-head">Scouts</h2>
			...
			<div class="experience" id="outdoor-sports">
				<h2 class="experience-head">Outdoor Sports</h2>
